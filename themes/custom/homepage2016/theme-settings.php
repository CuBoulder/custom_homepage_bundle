...
function homepage2016_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['expressbase_theme_settings']['page_title_image']['page_title_image_width']['#access'] = FALSE;
	...
	$form['expressbase_theme_settings']['layout']['layout_style'] = array(
	  ...
	  '#default_value' => theme_get_setting('layout_style', 'homepage2016') ? theme_get_setting('layout_style', 'homepage2016') : 'layout-wide',
